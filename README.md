...
> Built by [Artur Ferreira](https://thegeolab.net/about/) for [thegeolab.net](https://thegeolab.net) — where we manage 12+ Nginx redirects across a growing content architecture.
